 ...
 * @author DELL
 */
public class addParkingForm extends javax.swing.JFrame {
    private HomeAdminForm h;
    /**
     * Creates new form addParking
     */
    ...
    public addParkingForm(HomeAdminForm h, JButton addButton) {
        initComponents();
        this.h = h;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ADD PARKING SLOT");
        ...
        addParkingSlotButton.setBackground(new java.awt.Color(153, 153, 0));
        addParkingSlotButton.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        addParkingSlotButton.setForeground(new java.awt.Color(255, 255, 255));
        addParkingSlotButton.setText("ADD");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(209, 209, 209)
                        .addComponent(addParkingSlotButton, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(licensePlateField))
                .addGap(29, 29, 29)
                .addComponent(addParkingSlotButton, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void addParkingSlotButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addParkingSlotButtonActionPerformed
        ...
        int countRecord = 0;
        try {
            countRecord = p.addParkingSlot(slotNameText, slotTypeText, vehicleText, statusText, licensePlateText);
        ...
        if (countRecord > 0) {
            ...
            JOptionPane.showMessageDialog(this, "Add parking slot successful!");
            //            hide();
        }
        else {
            JOptionPane optionPane = new JOptionPane("Add parking slot failed!", JOptionPane.ERROR_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(addParkingForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new addParkingForm().setVisible(true);
            }
        });
    }
