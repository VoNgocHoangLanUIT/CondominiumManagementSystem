...
public class UserJava { 
    ...
    public int themUser(String username, String password, String fullname, String email) throws SQLException, ClassNotFoundException {
        int i = 0;
...
//                    +maDoi+"','"+tenDoi+"','"+quocGia+"')";
            ...
            String query = "INSERT INTO ACCOUNT(USERNAME,PASSWORD_HASH, FULL_NAME, EMAIL) VALUES(?,?,?,?)";
